  ...
  return (
    <header className="sticky top-0 z-50 bg-white border-b border-gray-200 shadow-sm py-2">
      <div className="max-w-7xl mx-auto px-4 flex items-center justify-between gap-4">
        ...
        {/* Left side: College Logo & College Name */}
        ...
        <div className="flex shrink-0 items-center justify-end gap-4 md:gap-6">
          ...
          <div className="hidden lg:flex flex-col items-end gap-3 text-gray-500 mt-1">
            ...
            <div className="flex items-center gap-4">
              <a href="https://facebook.com/" target="_blank" rel="noopener noreferrer" className="hover:text-blue-600 transition-colors" title="Facebook">
                <Facebook size={18} />
              </a>
              ...
              <a href="https://twitter.com/" target="_blank" rel="noopener noreferrer" className="hover:text-blue-400 transition-colors" title="Twitter">
                <Twitter size={18} />
              </a>
            </div>
            ...
            <div className="relative mt-1" ref={dropdownRef}>
              <form onSubmit={handleSearch} className="relative z-10 w-full flex justify-end">
                <input 
                  ...
                  className="text-xs border border-blue-200 rounded-full pl-3 pr-8 py-1.5 bg-blue-50 focus:bg-white focus:outline-none focus:ring-1 focus:ring-blue-800 w-44 md:w-56 transition-all shadow-sm" 
                />
                <button type="submit" className="absolute right-2 top-1.5 text-blue-800 hover:text-blue-600 transition-colors">
                  <Search size={14} />
                </button>
              </form>
                      ...
                      {results.map((result, idx) => (
                        <li key={idx}>
                          <button 
                            ...
                            className="w-full text-left px-4 py-2 hover:bg-blue-50 focus:bg-blue-50 focus:outline-none border-b border-gray-50 last:border-0 transition-colors"
                          >
                           <p className="text-sm font-semibold text-blue-800">{result.title}</p>
